...
##############################################
    ...
    mats['Inconel 718'].temperature = 900
    ...
    mats['Zircaloy 4'].temperature = 900
    ...
    mats['Carbon Steel'].temperature = 900
...
########## Borosilicate Glass #################
    ...
    mats['Borosilicate Glass'].temperature = 900
...
########## Borated Water #################
    ...
    mats['Borated Water'].temperature = 580
...
########## Nozzle / Support Plate Borated Materials #################
    ...
    mats['Water SPN'].temperature = 580
    ...
    mats['SS304 SPN'].temperature = 900
